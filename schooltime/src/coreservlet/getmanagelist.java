...
public class getmanagelist extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public getmanagelist() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String organizationId=request.getParameter("oganizationid").toString();
		...
		if(currentid.equals("0")){
			...
			ac.setOrganizationId(new ObjectId(organizationId));
			try {
			...
			ac1.setOrganizationId(new ObjectId(organizationId));
			try {
